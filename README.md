...
<br/>
**[eta-controle-app](https://github.com/InRenck/eta-controle-app)**
<p>An Android application designed to manage orders, products, and inventory for small businesses, focusing on performance and usability.</p>
<p>
...
**[ToDoAppConsole](https://github.com/InRenck/ToDoAppConsole)**
<p>A C# console application for managing to-do lists. It allows users to interactively add, view, and delete tasks.</p>
<p>
